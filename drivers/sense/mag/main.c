...
LOG_MODULE_REGISTER(sense_mag, CONFIG_ZROS_SENSE_MAG_LOG_LEVEL);
...
typedef struct context {
	...
	const struct device *device[CONFIG_ZROS_SENSE_MAG_COUNT];
...
void mag_work_handler(struct k_work *work)
{
	...
	double mag_data_array[CONFIG_ZROS_SENSE_MAG_COUNT][3] = {};
	...
	double A[3][3] = {
		{2.0199, -0.0516, 0.1352}, {0.0000, 1.9783, -0.0096}, {0.0000, 0.0000, 2.0242}};
